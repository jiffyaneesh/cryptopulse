...
const METRIC_TOOLTIPS = {
  ...
  VOLUME: "24-hour trading volume in USD millions from the last tick.",
...
export default function MarketStructure({ activeCoin, stats }) {
  ...
  const price      = latest?.price_usd
    ? `$${latest.price_usd.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`
    : "---";
